        ...
        <section className='login-page'>
            <div className='login create-note'>
                ...
                <form onSubmit={loginSubmit}>
                    ...
                    <p>You don't have account?<span onClick={()=>setOnLogin(true)}>Register</span></p>
                    <h3>{err}</h3>
                </form>
            </div>
            <div className='register create-note' style={style}>
                ...
                <form onSubmit={registerSubmit}>
                    <input type='text' name='name' id='register-name' placeholder='Enter Your Name' required value={user.name} onChange={onChangeInput} />
